...
(
  ...
  eid          NUMBER(11),
  asDate       DATE,
  beforeSalary NUMBER(11),
  afterSalary  NUMBER(11),
...
comment on column adjustsalary.asDate
  is '调薪日期';
comment on column adjustsalary.beforeSalary
  is '调前薪资';
comment on column adjustsalary.afterSalary
  is '调后薪资';
comment on column adjustsalary.reason
  is '调薪原因';
comment on column adjustsalary.remark
  is '备注';
-- Create/Recreate primary, unique and foreign key constraints
alter table adjustsalary
  add primary key (ID)
  using index
  tablespace TS_STS_D
  pctfree 10
...
create index pid on adjustsalary (eid)
  tablespace TS_STS_D
  pctfree 10
  initrans 2
  maxtrans 255
...
(
  ...
  eid        NUMBER(11),
  appDate    DATE,
  appResult  NVARCHAR2(32),
  appContent NVARCHAR2(255),
  remark     NVARCHAR2(255)
)
tablespace TS_STS_D
  pctfree 10
...
-- Add comments to the columns
comment on column appraise.appDate
  is '考评日期';
comment on column appraise.appResult
  is '考评结果';
comment on column appraise.appContent
  is '考评内容';
comment on column appraise.remark
  is '备注';
...
(
  ...
  birthday       DATE,
  idCard         NCHAR(18),
  wedlock        NVARCHAR2(255),
  nationId       NUMBER(11),
  nativePlace    NVARCHAR2(20),
  politicId      NUMBER(11),
  email          NVARCHAR2(20),
  phone          NVARCHAR2(11),
  address        NVARCHAR2(64),
  departmentId   NUMBER(11),
  jobLevelId     NUMBER(11),
  posId          NUMBER(11),
  engageForm     NVARCHAR2(8),
  tiptopDegree   NVARCHAR2(255),
  specialty      NVARCHAR2(32),
  school         NVARCHAR2(32),
  beginDate      DATE,
  workState      NVARCHAR2(255),
  workID         NCHAR(8),
  contractTerm   NUMBER,
  conversionTime DATE,
  notWorkDate    DATE,
...
comment on column employee.birthday
  is '出生日期';
comment on column employee.idCard
  is '身份证号';
comment on column employee.wedlock
  is '婚姻状况';
comment on column employee.nationId
  is '民族';
comment on column employee.nativePlace
  is '籍贯';
comment on column employee.politicId
  is '政治面貌';
...
comment on column employee.departmentId
  is '所属部门';
comment on column employee.jobLevelId
  is '职称ID';
comment on column employee.posId
  is '职位ID';
comment on column employee.engageForm
  is '聘用形式';
comment on column employee.tiptopDegree
  is '最高学历';
comment on column employee.specialty
  is '所属专业';
comment on column employee.school
  is '毕业院校';
comment on column employee.beginDate
  is '入职日期';
comment on column employee.workState
  is '在职状态';
comment on column employee.workID
  is '工号';
comment on column employee.contractTerm
  is '合同期限';
comment on column employee.conversionTime
  is '转正日期';
comment on column employee.notWorkDate
  is '离职日期';
comment on column employee.beginContract
  is '合同起始日期';
comment on column employee.endContract
  is '合同终止日期';
comment on column employee.workAge
  is '工龄';
...
-- Add comments to the columns
comment on column employeeec.eid
  is '员工编号';
comment on column employeeec.ecDate
  is '奖罚日期';
comment on column employeeec.ecReason
  is '奖罚原因';
comment on column employeeec.ecPoint
  is '奖罚分';
comment on column employeeec.ecType
  is '奖罚类别，0：奖，1：罚';
comment on column employeeec.remark
  is '备注';
...
(
  id         NUMBER(11) not null,
  eid        NUMBER(11),
  afterDepId NUMBER(11),
  afterJobId NUMBER(11),
  removeDate DATE,
  reason     NVARCHAR2(255),
  remark     NVARCHAR2(255)
)
...
-- Add comments to the columns
comment on column employeeremove.afterDepId
  is '调动后部门';
comment on column employeeremove.afterJobId
  is '调动后职位';
comment on column employeeremove.removeDate
  is '调动日期';
comment on column employeeremove.reason
  is '调动原因';
...
-- Add comments to the columns
comment on column employeetrain.eid
  is '员工编号';
comment on column employeetrain.trainDate
  is '培训日期';
comment on column employeetrain.trainContent
  is '培训内容';
comment on column employeetrain.remark
  is '备注';
...
(
  ...
  name      NVARCHAR2(32),
  phone     NCHAR(11),
  telephone NVARCHAR2(16),
  address   NVARCHAR2(64),
  enabled   NUMBER(4),
  username  NVARCHAR2(255),
  password  NVARCHAR2(255),
  userface  NVARCHAR2(255),
  remark    NVARCHAR2(255)
)
tablespace TS_STS_D
  pctfree 10
...
-- Add comments to the columns
comment on column hr.id
  is 'hrID';
comment on column hr.name
  is '姓名';
comment on column hr.phone
  is '手机号码';
comment on column hr.telephone
  is '住宅电话';
comment on column hr.address
  is '联系地址';
comment on column hr.username
  is '用户名';
comment on column hr.password
  is '密码';
...
-- Add comments to the columns
comment on column joblevel.name
  is '职称名称';
...
(
  ...
  url         NVARCHAR2(64),
  path        NVARCHAR2(64),
  component   NVARCHAR2(64),
  name        NVARCHAR2(64),
  iconCls     NVARCHAR2(64),
  keepAlive   NUMBER(4),
...
-- Add comments to the columns
comment on column oplog.addDate
  is '添加日期';
comment on column oplog.operate
  is '操作内容';
comment on column oplog.hrid
  is '操作员ID';
...
-- Add comments to the columns
comment on column position.name
  is '职位';
...
(
  id                   NUMBER(11) not null,
  basicSalary          NUMBER(11),
  bonus                NUMBER(11),
  lunchSalary          NUMBER(11),
  trafficSalary        NUMBER(11),
  allSalary            NUMBER(11),
  pensionBase          NUMBER(11),
  pensionPer           NUMBER,
  createDate           DATE,
  medicalBase          NUMBER(11),
  medicalPer           NUMBER,
  accumulationFundBase NUMBER(11),
...
-- Add comments to the columns
comment on column salary.basicSalary
  is '基本工资';
comment on column salary.bonus
  is '奖金';
comment on column salary.lunchSalary
  is '午餐补助';
comment on column salary.trafficSalary
  is '交通补助';
comment on column salary.allSalary
  is '应发工资';
comment on column salary.pensionBase
  is '养老金基数';
comment on column salary.pensionPer
  is '养老金比率';
comment on column salary.createDate
  is '启用时间';
comment on column salary.medicalBase
  is '医疗基数';
comment on column salary.medicalPer
  is '医疗保险比率';
comment on column salary.accumulationFundBase
  is '公积金基数';
comment on column salary.accumulationFundPer
  is '公积金比率';
...
-- Add comments to the columns
comment on column sysmsg.mid
  is '消息id';
comment on column sysmsg.type
  is '0表示群发消息';
comment on column sysmsg.hrid
  is '这条消息是给谁的';
comment on column sysmsg.state
  is '0 未读 1 已读';
--
